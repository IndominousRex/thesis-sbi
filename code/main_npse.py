...
from inference.npse_experiment import run_npse_experiment
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Run NPSE (Neural Posterior Score Estimation) experiment for vehicle model."
    )
    p.add_argument("--exp-name", type=str, default="baseline_npse")
    ...
    p.add_argument(
        ...
        default="ve",
        help=(
            "SDE type for diffusion process: "
...
def main():
    ...
    run_npse_experiment(cfg, sde_type=args.sde_type)
